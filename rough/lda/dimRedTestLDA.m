...
function [dataSet] = dimRedTestLDA(data, dataGray, labelVec, dim, numSamplesPerChar, numClasses, reducFact, nVecs, rowDiv, colDiv, nHarmonics, trainingLabels)
...
% Does not work as you need supervised labels....
end