...
function [dataSet nVecs cummulVar, net, network] = dimRedNN(data, dataGray, labelVec, n, dim, numSamplesPerChar, numClasses, reducFact, rowDiv, colDiv, nHarmonics)
...
[nVecs, net, network] = nlpca(dataInput, n);
dataSet = nVecs;
