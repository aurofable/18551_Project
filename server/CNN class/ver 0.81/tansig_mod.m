function out1 = tansig_mod(in1,in2,in3,in4)
%This standard tansig function from NNToolbox modified to have output=1
%with input = 1
...
% $Revision: 1.1.6.4 $  $Date: 2007/05/23 18:57:49 $
