...
for i = 1:m
    testLabels((i-1)*numTestSamples+1:i*numTestSamples) = labelVec(i)*ones(numTestSamples, 1);
end

% Creating the test data
testData = dimRedTest(imgDataTestSeg, imgDataTestSegGray, labelVec, dim, numTestSamples, m, reducFact, nVecs, rowDiv, colDiv, nHarmonics);
