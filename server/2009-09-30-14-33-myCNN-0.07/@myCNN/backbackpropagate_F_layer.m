function net = backbackpropagate_F_layer(net, l_i)
% method NET = BACKBACKPROPAGATE_F_LAYER(NET, L_I)
% backpropagates second derivatives through a fully connected (F-) layer
%
% INPUT:
%   NET             - myCNN object
%   L_I             - layer index
...
%
% BACKBACKPROPAGATE_F_LAYER is a part of a matlab implementation of the extended
...
% Last update: 2009-09-01
    ...
    for FM_i = 1:net.layer(l_i).n_FMs,
        ...
        for in_i = 1:net.layer(l_i).FM(FM_i).n_in,
            ...
            % compute convolution
            % accumulate subsampled convolution
...
end % of method BACKBACKPROPAGATE_F_LAYER