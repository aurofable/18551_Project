...
train_samples_per_class = 2;            % how many samples per class should be used for training
test_samples_per_class  = 1;            % how many samples per class should be used for testing
...
if ispc,
    mnist_dir = 'C:\Users\James\git\18551_Project\server\2009-09-30-14-33-myCNN-0.07\MNIST\'; % Windows
else
