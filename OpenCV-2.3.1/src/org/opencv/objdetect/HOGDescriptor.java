...
public class HOGDescriptor {
    ...
    public  void compute(Mat img, List<Float> descriptors, Size winStride, Size padding, List<Point> locations)
    {
        Mat descriptors_mat = new Mat();
        Mat locations_mat = Converters.vector_Point_to_Mat(locations);
        ...
        Converters.Mat_to_vector_float(descriptors_mat, descriptors);
        return;
    }

    public  void compute(Mat img, List<Float> descriptors, Size winStride, Size padding)
    {
        Mat descriptors_mat = new Mat();
    ...
    public  void compute(Mat img, List<Float> descriptors, Size winStride)
    {
        Mat descriptors_mat = new Mat();
    ...
    public  void compute(Mat img, List<Float> descriptors)
    {
        Mat descriptors_mat = new Mat();
    ...
    public  void detect(Mat img, List<Point> foundLocations, List<Double> weights, double hitThreshold, Size winStride, Size padding, List<Point> searchLocations)
    {
        Mat foundLocations_mat = new Mat();
        Mat weights_mat = Converters.vector_double_to_Mat(weights);
        Mat searchLocations_mat = Converters.vector_Point_to_Mat(searchLocations);
        ...
        Converters.Mat_to_vector_Point(foundLocations_mat, foundLocations);
        return;
    }

    public  void detect(Mat img, List<Point> foundLocations, List<Double> weights, double hitThreshold, Size winStride, Size padding)
    {
        Mat foundLocations_mat = new Mat();
        Mat weights_mat = Converters.vector_double_to_Mat(weights);
    ...
    public  void detect(Mat img, List<Point> foundLocations, List<Double> weights, double hitThreshold, Size winStride)
    {
        Mat foundLocations_mat = new Mat();
        Mat weights_mat = Converters.vector_double_to_Mat(weights);
    ...
    public  void detect(Mat img, List<Point> foundLocations, List<Double> weights, double hitThreshold)
    {
        Mat foundLocations_mat = new Mat();
        Mat weights_mat = Converters.vector_double_to_Mat(weights);
    ...
    public  void detect(Mat img, List<Point> foundLocations, List<Double> weights)
    {
        Mat foundLocations_mat = new Mat();
        Mat weights_mat = Converters.vector_double_to_Mat(weights);
    ...
    public  void detect(Mat img, List<Point> foundLocations, double hitThreshold, Size winStride, Size padding, List<Point> searchLocations)
    {
        Mat foundLocations_mat = new Mat();
        Mat searchLocations_mat = Converters.vector_Point_to_Mat(searchLocations);
        detect_5(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height, searchLocations_mat.nativeObj);
        Converters.Mat_to_vector_Point(foundLocations_mat, foundLocations);
        return;
    }

    public  void detect(Mat img, List<Point> foundLocations, double hitThreshold, Size winStride, Size padding)
    {
        Mat foundLocations_mat = new Mat();
        detect_6(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height);
        Converters.Mat_to_vector_Point(foundLocations_mat, foundLocations);
        return;
    }

    public  void detect(Mat img, List<Point> foundLocations, double hitThreshold, Size winStride)
    {
        Mat foundLocations_mat = new Mat();
        detect_7(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height);
        Converters.Mat_to_vector_Point(foundLocations_mat, foundLocations);
        return;
    }

    public  void detect(Mat img, List<Point> foundLocations, double hitThreshold)
    {
        Mat foundLocations_mat = new Mat();
        detect_8(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold);
        Converters.Mat_to_vector_Point(foundLocations_mat, foundLocations);
        return;
    }

    public  void detect(Mat img, List<Point> foundLocations)
    {
        Mat foundLocations_mat = new Mat();
        detect_9(nativeObj, img.nativeObj, foundLocations_mat.nativeObj);
        Converters.Mat_to_vector_Point(foundLocations_mat, foundLocations);
        return;
    }
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights, double hitThreshold, Size winStride, Size padding, double scale, double finalThreshold, boolean useMeanshiftGrouping)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
        ...
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights, double hitThreshold, Size winStride, Size padding, double scale, double finalThreshold)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights, double hitThreshold, Size winStride, Size padding, double scale)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights, double hitThreshold, Size winStride, Size padding)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights, double hitThreshold, Size winStride)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights, double hitThreshold)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, List<Double> foundWeights)
    {
        Mat foundLocations_mat = new Mat();
        Mat foundWeights_mat = Converters.vector_double_to_Mat(foundWeights);
    ...
    public  void detectMultiScale(Mat img, List<Rect> foundLocations, double hitThreshold, Size winStride, Size padding, double scale, double finalThreshold, boolean useMeanshiftGrouping)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_7(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height, scale, finalThreshold, useMeanshiftGrouping);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations, double hitThreshold, Size winStride, Size padding, double scale, double finalThreshold)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_8(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height, scale, finalThreshold);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations, double hitThreshold, Size winStride, Size padding, double scale)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_9(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height, scale);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations, double hitThreshold, Size winStride, Size padding)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_10(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations, double hitThreshold, Size winStride)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_11(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold, winStride.width, winStride.height);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations, double hitThreshold)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_12(nativeObj, img.nativeObj, foundLocations_mat.nativeObj, hitThreshold);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }

    public  void detectMultiScale(Mat img, List<Rect> foundLocations)
    {
        Mat foundLocations_mat = new Mat();
        detectMultiScale_13(nativeObj, img.nativeObj, foundLocations_mat.nativeObj);
        Converters.Mat_to_vector_Rect(foundLocations_mat, foundLocations);
        return;
    }
    ...
    public static List<Float> getDaimlerPeopleDetector()
    {
        List<Float> retVal = new ArrayList<Float>();
        Mat retValMat = new Mat(getDaimlerPeopleDetector_0());
        Converters.Mat_to_vector_float(retValMat, retVal);
        return retVal;
    }
    ...
    public static List<Float> getDefaultPeopleDetector()
    {
        List<Float> retVal = new ArrayList<Float>();
        Mat retValMat = new Mat(getDefaultPeopleDetector_0());
        Converters.Mat_to_vector_float(retValMat, retVal);
        return retVal;
    }
    ...
    public  void setSVMDetector(List<Float> _svmdetector)
    {
        Mat _svmdetector_mat = Converters.vector_float_to_Mat(_svmdetector);
        setSVMDetector_0(nativeObj, _svmdetector_mat.nativeObj);
    ...
    public  List<Float> get_svmDetector()
    {
        List<Float> retVal = new ArrayList<Float>();
        Mat retValMat = new Mat(get_svmDetector_0(nativeObj));
        Converters.Mat_to_vector_float(retValMat, retVal);
        return retVal;
    }
    ...
    // C++:  void HOGDescriptor::detect(Mat img, vector_Point& foundLocations, double hitThreshold = 0, Size winStride = Size(), Size padding = Size(), vector_Point searchLocations = vector<Point>())
    private static native void detect_5(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height, double padding_width, double padding_height, long searchLocations_mat_nativeObj);
    private static native void detect_6(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height, double padding_width, double padding_height);
    private static native void detect_7(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height);
    private static native void detect_8(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold);
    private static native void detect_9(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj);
    ...
    // C++:  void HOGDescriptor::detectMultiScale(Mat img, vector_Rect& foundLocations, double hitThreshold = 0, Size winStride = Size(), Size padding = Size(), double scale = 1.05, double finalThreshold = 2.0, bool useMeanshiftGrouping = false)
    private static native void detectMultiScale_7(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height, double padding_width, double padding_height, double scale, double finalThreshold, boolean useMeanshiftGrouping);
    private static native void detectMultiScale_8(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height, double padding_width, double padding_height, double scale, double finalThreshold);
    private static native void detectMultiScale_9(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height, double padding_width, double padding_height, double scale);
    private static native void detectMultiScale_10(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height, double padding_width, double padding_height);
    private static native void detectMultiScale_11(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold, double winStride_width, double winStride_height);
    private static native void detectMultiScale_12(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj, double hitThreshold);
    private static native void detectMultiScale_13(long nativeObj, long img_nativeObj, long foundLocations_mat_nativeObj);
    ...
    // C++:  void HOGDescriptor::setSVMDetector(vector_float _svmdetector)
    private static native void setSVMDetector_0(long nativeObj, long _svmdetector_mat_nativeObj);
